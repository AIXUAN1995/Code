...
public class OsInterphase extends JWindow implements Runnable{
	...
	OsInterphase()
	{
		...
		tabs.add(panel_co,"进程" );//创建相应的选项卡
		tabs.add(panel_eq,"设备");//创建相应的选项卡
		tabs.add(panel_fi,"文件" );//创建相应的选项卡
		tabs.add(panel_st,"内存" );//创建相应的选项卡
	 ...
	 public void start(){
	  ...
	  public void showFrame(){
		  contentPane = important.getContentPane();
			...
			important.setSize(800, 710);
			important.setVisible(true);
			important.setLocation(300,20); //设置窗口位置
